...
void RTS::onIdle() {
  ...
  if (startprogress == 0) {
    ...
    show_status = true;
    tpShowStatus = false;
    // Show the main UI page expected by this build (screen #28)
    rts.sendData(ExchangePageBase + 28, ExchangepageAddr);
    no_reentry = false;
    return;
  }
