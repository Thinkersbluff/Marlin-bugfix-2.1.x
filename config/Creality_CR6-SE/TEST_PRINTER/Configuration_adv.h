...
//#define INPUT_SHAPING_Z
    ...
    #define SHAPING_FREQ_Y  39.0        // (Hz) The default dominant resonant frequency on the Y axis.
    #define SHAPING_ZETA_Y   0.20       // Damping ratio of the Y axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
...
#define FWRETRACT
  ...
  #define FWRETRACT_AUTORETRACT             // Override slicer retractions
    ...
    #define MAX_AUTORETRACT            1.0 // (mm) Don't convert E moves over this length
  #endif
  #define RETRACT_LENGTH                0.8   // (mm) Default retract length (positive value)
  #define RETRACT_LENGTH_SWAP          1.0   // (mm) Default swap retract length (positive value)
...
/**
 * ADVANCED_PAUSE_FEATURE IS NOT SUPPORTED BY CR6_2.1.x FIRMWARE - USES CUSTOM M1125.cpp instead!
 *  M600 is defined as an alias of M1125 P0, to maintain 
 * compatibility with use of M600 in slicer and Octoprint settings.
 *
...
// #define ADVANCED_PAUSE_FEATURE
  ...
  #define ADVANCED_PAUSE_PURGE_FEEDRATE        0  // (mm/s) Extrude feedrate (after loading). Should be slower than load feedrate.
...
//#define NO_VOLUMETRICS
  ...
  //#define VOLUMETRIC_EXTRUDER_LIMIT
     ...
     */
    #define DEFAULT_VOLUMETRIC_EXTRUDER_LIMIT  15.00     // (mm^3/sec)
